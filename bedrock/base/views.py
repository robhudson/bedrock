...
def page_locale_not_found_view(request, exception=None, template_name="404-locale.html"):
    """404 locale error handler that runs context processors."""
    return l10n_utils.render(request, template_name, ftl_files=["404-locale"], status=404)
